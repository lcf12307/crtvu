...
public class GMTeacherController {
    ...
    @ResponseBody
    public String addSubject(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        int teacherId = 0;
        try {
        ...
        String requirement = '\n'+req.getParameter("subjectRequirement");
    ...
    @ResponseBody
    public String update(@PathVariable("teacherId")int teacherId, @PathVariable("subjectId") int subjectId,HttpServletRequest req, HttpServletResponse resp) throws IOException {

        String subjectName = req.getParameter("subjectName");
        String requirement = req.getParameter("subjectRequirement");
    ...
    //确定学生
    @RequestMapping(value = "/confirm/{studentId}")
    @ResponseBody
